      ...
      <div className="lg:flex lg:flex-row flex-col items-center gap-[100px] my-[100px] lg:pl-[50px] pl-0">
        <div data-aos="fade-right">
          <h1 className="lg:text-[45px] text-[30px] tracking-tight">
            {edition.shortTitle} Schedule
          </h1>
          <p className="lg:w-[400px] w-auto tracking-tight text-[#6B6F76] mt-3">
            Get ready for all the excitement! Here&apos;s the full schedule for
            the {edition.fullTitle}. Stay informed about match dates, kick-off
            times, and venue so you can plan to participate or cheer for your
            favourite team(s). Let the competition begin!
          </p>
        </div>
