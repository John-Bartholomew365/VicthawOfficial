        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {processedTeams.map((team, index) => (
            <tr key={team.id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{team.matchesPlayed}</td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{team.draws}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{team.gf}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{team.ga}</td>
              <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium ${
                team.gd > 0 ? 'text-green-600' : team.gd < 0 ? 'text-red-600' : 'text-gray-900'
              }`}>
