...
//               Tournament Dates:
//             </span>
//             <span className="text-[#6B6F76]">12th April – 29th June 2025</span>
//           </div>
//           <div className="flex flex-col items-center">
//             <span className="font-bold lg:text-[20px] text-[16px]">
//               Number of Teams:
    ...
    <div className="p-6 max-w-3xl mx-auto tracking-tight relative">
      {allLeagueMatchesCompleted && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-8 flex items-center">
          <div>
            ...
            <p className="text-green-600 text-sm mr-10">
              All matches have been played except the Grand Finale between NBA FC and Bankers All Stars!
            </p>
          </div>
        </div>
      )}
      ...
      <div className="text-center">
        ...
        <div className="space-y-5 mb-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-[#6B6F76]">Final Match</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="font-bold lg:text-[20px] text-[16px]">
              Final Match:
            </span>
            <span className="text-[#6B6F76]">NBA FC vs Bankers All Stars</span>
          </div>
        </div>
        <h2 className="text-[#C81E23] mt-4">
          The tournament concludes with the Final on June 29th!
        </h2>
      </div>
              ...
              <div key={matchday} className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg p-4 text-center mt-3">
                  ...
                  {matchday === "Final" ? (
                    <div>
                      <p className="text-gray-600 text-sm">
                        The tournament will conclude with this match!
                      </p>
                    </div>
                  ) : (
                    <p className="text-gray-600 text-sm">
      ...
      {visibleMatchdays < matchdayKeys.length && (
        <div className="flex justify-center mt-6">
          ...
          >
            {isLoading ? "Loading..." : "View Previous Matchdays"}
          </button>
        </div>
      )}
      ...
      {/* Important Notes Section */}
      <div className="lg:p-6 p-1 max-w-3xl mx-auto mt-16">
        <h1 className="text-[25px] text-[#C81E23] lg:text-[35px] font-bold mb-8 text-center leading-tight">
          Tournament Final Information
        </h1>
        <div className="space-y-6">
          <div className="flex flex-col gap-3">
            <div className="flex gap-4 items-center">
              <FaClock className="text-[#C81E23] text-2xl" />
              <h1 className="text-[18px] font-bold">Final Match Time:</h1>
            </div>
            <p className="text-[#6B6F76] mt-[-10px] ml-[40px] lg:w-[350px] w-auto">
              The final match will be played on June 29th at 4:00pm.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#6B6F76] mt-[-10px] ml-[40px]">
              Parking will be available at the stadium. Arrive early as large crowds are expected for the final.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-4 items-center">
              ...
              <h1 className="text-[18px] font-bold">Prize Ceremony:</h1>
            </div>
            <p className="text-[#6B6F76] mt-[-10px] ml-[40px]">
              The trophy presentation and awards ceremony will take place immediately after the final match.
            </p>
          </div>
        </div>
      </div>
