      ...
      {selectedMatch && (
        ...
        >
          ...
          >
            ...
            {/* Tabs for First Leg and Second Leg */}
            <div className="flex justify-center gap-4 mb-6">
              ...
              <button
                ...
                onClick={() => setActiveTab("secondLeg")}
              >
                Second Leg
              </button>
            </div>
            ...
            {activeTab === "secondLeg" && (
              <>
                <div className="flex justify-between items-center mb-4">
                  <div className="flex flex-col items-center">
                    <img
                      src={selectedMatch.awayLogo} // Swapped logo
                      alt={selectedMatch.away}
                      className="w-12 h-12 sm:w-16 sm:h-16"
                    />
                    <p className="mt-2 text-white lg:text-sm text-[17px] font-semibold truncate">
                      {selectedMatch.away} {/* Swapped team */}
                      <span className="text-[#B0B3B8] ml-2">
                        ({selectedMatch.firstLegScore.split(" - ")[1]}) {/* Away team's score */}
                      </span>
                    </p>
                  </div>
                  <p className="text-lg font-bold">VS</p>
                  <div className="flex flex-col items-center">
                    <img
                      src={selectedMatch.homeLogo} // Swapped logo
                      alt={selectedMatch.home}
                      className="w-12 h-12 sm:w-16 sm:h-16"
                    />
                    <p className="mt-2 text-white lg:text-sm text-[17px] font-semibold truncate">
                      {selectedMatch.home} {/* Swapped team */}
                      <span className="text-[#B0B3B8] ml-2">
                        ({selectedMatch.firstLegScore.split(" - ")[0]}) {/* Home team's score */}
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <p className="text-[#B0B3B8]">
                  Stage:{" "}
                  <span className="font-bold text-white">
                    {selectedMatch.stage.replace("First", "Second")}
                  </span>
                </p>
              </>
            )}
