      ...
      <main className="container mx-auto p-4">
        <section className="">
          <div className="space-y-8">
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">
                The Victhaw Official Unity Cup 1.0
              </h3>
              <p className="text-[#6B6F76] mb-4">
                The inaugural Unity Cup was a spectacular football tournament that united teams from different backgrounds in a celebration of competitive spirit and sportsmanship. It showcased teamwork, skill, and the power of unity through football.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Our Mission</h3>
              <p className="text-[#6B6F76] mb-4">
                We created a platform where talented players competed at their best, showcased their abilities, and strengthened community bonds through their shared love of the game.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Tournament Highlights</h3>
              <p className="text-[#6B6F76] mb-4">
                The competition featured intense knockout matches that tested strategy, teamwork, and resilience, culminating in an unforgettable grand final.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Celebrating Success</h3>
              <p className="text-[#6B6F76] mb-4">
                The Unity Cup 1.0 rewarded outstanding performance with trophies, medals, and cash prizes, recognizing both team achievements and individual excellence.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Our Partners</h3>
              <p className="text-[#6B6F76] mb-4">
                This landmark tournament was made possible through the support of our valued sponsors and partners who share our passion for sports and community development.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Community Impact</h3>
              <p className="text-[#6B6F76] mb-4">
                Beyond the matches, Unity Cup 1.0 brought people together through fan engagement activities, live updates, and interactive events that created lasting memories.
              </p>
            </article>
            <article className="bg-[#FAFAFA] shadow-md rounded-lg p-6">
              <h3 className="text-xl font-bold mb-2">Relive the Experience</h3>
              <p className="text-[#6B6F76] mb-4">
                Explore match highlights, tournament statistics, and memorable moments from this groundbreaking event.
              </p>
            </article>
          </div>
        </section>
