  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        setIsLoading(false); // Set loading to false when registration ends
      }
    },
  });
    ...
    <div className="pt-24 flex flex-col items-center tracking-tight">
      ...
      >
        ...
        <div className="my-8" data-aos="fade-up">
          <button
            type="submit"
            className={`bg-[#C81E23] rounded-md p-2 text-white w-full transition-colors duration-200 ${
              isLoading ? "opacity-70 cursor-not-allowed" : "hover:bg-[#a81a1e]"
            }`}
