...
//       <form onSubmit={handleSubmit} className="w-full max-w-md" data-aos="fade-up">
...
const Register = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        formData.append("teamContact", values.teamContact);
  ...
  return (
    <div className="pt-24 flex flex-col items-center tracking-tight">
      <ToastContainer position="top-right" autoClose={3000} />
      <form onSubmit={formik.handleSubmit} className="w-full max-w-md" data-aos="fade-up">
        <div className="pt-6 text-left">
          <h2 className="font-bold text-[30px] leading-tight">
            Get in the Game! <br /> Create Your Team
          </h2>
        ...
        <div className="mt-9" data-aos="fade-up">
          ...
          {formik.touched.managerName && formik.errors.managerName && (
            <div className="text-red-500 text-sm mt-1">{formik.errors.managerName}</div>
          )}
        </div>
        ...
        <div className="mt-9" data-aos="fade-up">
          ...
          {formik.touched.teamContact && formik.errors.teamContact && (
            <div className="text-red-500 text-sm mt-1">{formik.errors.teamContact}</div>
          )}
        </div>
