...
//       answer: `
//           All matches will be played at <b style="color: #C81E23;">Basin Stadium, Ilorin, Kwara State,</b> from <b>April 12</b> to <b>June 29</b>
//         `,
//     },
//     {
...
const Questions = () => {
  ...
  const questions = [
    {
      question: "1. When did Unity Cup 1.0 take place?",
      answer: `
          The inaugural Unity Cup 1.0 tournament was held from <b>April 12 to June 29, 2024</b> at Basin Stadium, Ilorin, Kwara State.
        `,
    },
    {
      question: "2. Who were the winners of Unity Cup 1.0?",
      answer: `
        The tournament champions were <b style="color: #C81E23;">Bankers All Stars</b>, who demonstrated exceptional skill throughout the competition.
      `,
    },
    {
      question: "3. What was the tournament format?",
      answer: `
        Unity Cup 1.0 followed a <b style="color: #C81E23;">League Phase style</b> where teams competed in a league phase, with the top 2 teams advancing to the Final.
      `,
    },
    {
      question: "4. What prizes were awarded?",
      answer: `
          The tournament awarded:
          <ul style="margin-top: 10px; list-style: none; padding-left: 20px;">
            <li>
              <span style="color: #C81E23; margin-right: 10px;">•</span>
              <span style="color: #000000;">Champion: Gold Medal, Trophy, and Cash Prize</span>
            </li>
            <li>
              <span style="color: #C81E23; margin-right: 10px;">•</span>
              <span style="color: #000000;">Runner-up: Silver Medal and Sporting Equipment</span>
            </li>
            <li>
              <span style="color: #C81E23; margin-right: 10px;">•</span>
              <span style="color: #000000;">Individual Awards: MVP, Best Goalkeeper, Top Scorer, and Fair Play Award</span>
            </li>
          </ul>
        `,
    },
    {
      question: "5. How many teams participated?",
      answer: `
          Unity Cup 1.0 featured <b style="color: #C81E23;">7</b> competitive teams from various backgrounds.
        `,
    },
    {
      question: "6. Where can I view tournament highlights?",
      answer: `
          You can relive the excitement by visiting our <a href="/tournament/results" target="_blank" style="color: #C81E23; text-decoration: underline;">Tournament Results</a> page.
        `,
    },
    {
      question: "7. What was the age requirement for players?",
      answer: `
          The tournament was open to players aged <b style="color: #C81E23;">25 to 50 years</b>.
        `,
    },
    {
      question: "8. How many players were on each team?",
      answer: `
          Each team consisted of <b style="color: #C81E23;">22 players</b>, including <b style="color: #C81E23;">5 substitutes</b>.
          `,
    },
    {
      question: "9. How long were the matches?",
      answer: `
          Matches consisted of <b style="color: #C81E23;">two 30-minute halves</b>, with a <b style="color: #C81E23;">10-minute</b> halftime break.
          `,
    },
    {
      question: "10. Were there medical facilities available?",
      answer: `
           Yes, <b style="color: #C81E23;">first aid stations</b> were available at the venue throughout the tournament.
          `,
    },
    {
      question: "11. Can I still access tournament statistics?",
      answer: `
          Yes, match results and statistics are available on our <a href="/tournament/results" target="_blank" style="color: #C81E23; text-decoration: underline;">Tournament results</a> page.
          `,
    },
    {
      question: "12. How can I get involved in future events?",
      answer: `
          Follow our social media channels and website for announcements about upcoming football events and tournaments.
          `,
    },
  ];
  ...
  return (
    <div className="my-[100px] text-white">
      <div className="mb-16">
        ...
        <p className="text-[#6B6F76] lg:w-[470px] w-auto text-center m-auto my-3">
          Answers to common questions about the completed Unity Cup 1.0 tournament.
        </p>
      </div>
      ...
      <div className="mt-[100px] text-center">
        <h1 className="text-center text-black lg:text-[40px] text-[30px] mb-3 lg:w-[520px] w-auto leading-tight mx-auto" >
          Want to know more about Unity Cup 1.0?
        </h1>
        <p className="lg:w-[350px] w-auto m-auto text-[#6B6F76] mb-7">
          Contact us for additional information about the tournament.
        </p>
        <a
          href="mailto:victhawofficial@gmail.com"
          target="_blank"
