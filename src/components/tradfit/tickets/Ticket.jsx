...
export default function TicketsPage() {
  ...
  const regularWithClothBenefits = [
    { emoji: "👕", text: "Customized TRADFIT clothing", ariaLabel: "T-shirt icon" },
    { emoji: "🎵", text: "Access to all dance sessions", ariaLabel: "Music icon" },
    { emoji: "👥", text: "Community group activities", ariaLabel: "Users icon" },
    { emoji: "🍴", text: "Basic refreshments included", ariaLabel: "Utensils icon" },
    { emoji: "📶", text: "Free WiFi access", ariaLabel: "WiFi icon" },
  ...
  const vipBenefits = [
    { emoji: "👑", text: "Priority seating in premium area", ariaLabel: "Crown icon" },
    { emoji: "⭐", text: "Exclusive meet & greet with performers", ariaLabel: "Star icon" },
    { emoji: "🍴", text: "Premium traditional meal & beverages", ariaLabel: "Utensils icon" },
    { emoji: "🎁", text: "Exclusive TRADFIT merchandise bag", ariaLabel: "Gift icon" },
    { emoji: "📷", text: "Professional photo session", ariaLabel: "Camera icon" },
    { emoji: "🅿️", text: "Reserved VIP parking", ariaLabel: "Parking icon" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className=" text-[#C90A1D]/80 lg:w-[520px] w-auto mx-auto">
            Select the perfect ticket type for your indigenous dance aerobics journey. All options guarantee an
            unforgettable cultural fitness experience!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="shadow-xl border border-[#C90A1D]/30 rounded-lg bg-white relative">
            <div className="bg-[#C90A1D] text-white text-center p-6 rounded-t-lg">
              ...
              <h2 className="text-2xl font-bold">Regular Ticket</h2>
              <p className="text-white/80 text-sm">Perfect for fitness enthusiasts and cultural explorers</p>
              <div className="mt-4">
              ...
              <div className="space-y-4 mb-6">
                ...
                {regularBenefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <span className="text-[#C90A1D]/80 text-sm">{benefit.text}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="shadow-xl border border-[#C90A1D]/30 rounded-lg bg-white relative transform lg:scale-105 z-10">
            ...
            <div className="bg-gradient-to-r from-[#C90A1D] to-[#A30818] text-white text-center p-6 rounded-t-lg">
              <div className="flex justify-center mb-2">
                <span className="text-2xl" aria-label="T-shirt icon">👕</span>
              </div>
              <h2 className="text-2xl font-bold">Regular with Cloth</h2>
              <p className="text-white/80 text-sm">Complete experience with custom TRADFIT clothing</p>
              <div className="mt-4">
                <span className="bg-white/20 text-white text-lg px-4 py-2 rounded-md">
                  ₦8,000
                </span>
          ...
          <div className="shadow-xl border border-[#C90A1D]/30 rounded-lg bg-white relative overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-[#C90A1D] to-[#A30818] text-white text-center p-6 rounded-t-lg relative">
              ...
              <p className="text-white/80 text-sm">Ultimate luxury with exclusive surprises</p>
              <div className="mt-4">
                <span className="bg-white/20 text-white text-lg px-4 py-2 rounded-md">
                  ₦12,000
                </span>
            ...
            <div className="p-6 bg-gradient-to-b from-[#C90A1D]/5 to-white">
              <div className="space-y-4 mb-6">
                <h3 className="text-lg font-semibold text-[#C90A1D] mb-4 flex items-center gap-2">
                  <span className="text-sm" aria-label="Star icon">⭐</span> Exclusive VIP Perks:
                </h3>
                {vipBenefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <div className="flex-shrink-0 w-8 h-8 bg-[#C90A1D]/10 rounded-full flex items-center justify-center">
                ...
                {/* Mystery Benefits */}
                <div className="border-2 border-dashed border-[#C90A1D]/30 rounded-lg p-4 mt-4">
                  <div className="flex items-center gap-3">
                    <div className="flex-shrink-0 w-8 h-8 bg-[#C90A1D]/10 rounded-full flex items-center justify-center">
                      <span className="text-sm" aria-label="Mystery icon">🎁</span>
                    </div>
                    <div>
                      <span className="text-[#C90A1D] font-semibold text-sm">Exclusive Surprise Gifts</span>
                      <p className="text-[#C90A1D]/60 text-xs">Premium items worth over ₦5,000</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 mt-3">
                    <div className="flex-shrink-0 w-8 h-8 bg-[#C90A1D]/10 rounded-full flex items-center justify-center">
                      <span className="text-sm" aria-label="Star icon">💫</span>
                    </div>
                    <div>
                      <span className="text-[#C90A1D] font-semibold text-sm">Special VIP Surprises</span>
                      <p className="text-[#C90A1D]/60 text-xs">Memorable experiences you won't forget</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                answer: "You'll receive a premium customized TRADFIT outfit specially designed for the event activities.",
              },
              {
                question: "Is there an age limit?",
                answer: "The event is designed for ages 18 and above. All fitness levels are welcome!",
