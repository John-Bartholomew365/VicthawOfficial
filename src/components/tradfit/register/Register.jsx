...
export default function RegisterPage() {
  ...
  const renderStep1 = () => (
    <div data-aos="fade-up" data-aos-delay="200">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-[#C90A1D] mb-2">Personal Information</h3>
  ...
  const renderStep2 = () => (
    <div data-aos="fade-up" data-aos-delay="200">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-[#C90A1D] mb-2">Contact Information</h3>
  ...
  const renderStep3 = () => (
    <div data-aos="fade-up" data-aos-delay="200">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-[#C90A1D] mb-2">Additional Details</h3>
            ...
            {["male", "female", "other"].map((gender, index) => (
              ...
              >
                <input
                  ...
                  required
                />
                <label htmlFor={gender} className="text-[#C90A1D]/80 cursor-pointer capitalize">
                  {gender}
                </label>
              </div>
            ))}
  ...
  const renderStep4 = () => (
    <div data-aos="fade-up" data-aos-delay="200">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-[#C90A1D] mb-2">Select Your Ticket</h3>
      ...
      <div className="container mx-auto px-4 lg:px-24 max-w-2xl">
        ...
        <div className="mb-8" data-aos="fade-down">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-[#C90A1D]">Step {currentStep} of 4</span>
            <span className="text-sm text-[#C90A1D]/70">{Math.round((currentStep / 4) * 100)}% Complete</span>
          </div>
        ...
        <div className="text-center mb-8" data-aos="fade-up">
          <h1 className="lg:text-[30px] text-[26px] font-bold text-[#C90A1D] mb-3">Register for TRADFIT RHYTHMS</h1>
