    ...
    <div className="my-[60px] lg:my-[120px] px-4">
      <div>
        ...
        <p className="text-center text-lg text-[#6B6F76] mt-3 lg:w-[470px] w-auto mx-auto leading-tight">
          A successful football tournament that united communities and showcased
          incredible talent!
        </p>
      </div>
        ...
        {activeTab === "about" ? (
          <div className="flex flex-col lg:flex-row gap-[50px] lg:gap-[100px] text-center lg:text-left">
            ...
            <div>
              ...
              <p className="lg:w-[350px] w-full text-[#6B6F76] tracking-tight mt-2">
                Unity Cup 1.0 was successfully held at Basin, Ilorin, bringing
                together teams and fans for an unforgettable football
                experience.
              </p>
              <p className="text-[#6B6F76] tracking-tight mt-2 mb-7 lg:w-[350px] w-full">
                The tournament showcased incredible talent, sportsmanship, and
                community spirit that will be remembered for years to come.
              </p>
              <Link href="/tournament/results">
                <button className="bg-[#C81E23] hover:bg-[#A5161E] transition-colors py-[10px] px-[20px] text-white rounded-[6px]">
                  Relive the Moments
          ...
          <div className="flex flex-col-reverse lg:flex-row-reverse gap-[50px] lg:gap-[100px] text-center lg:text-left">
            ...
            <div>
              ...
              <p className="lg:w-[400px] w-full text-[#6B6F76] tracking-tight mt-2">
                Unity Cup 1.0 successfully brought our vision to life, uniting
              ...
              >
                <li className="text-[#C81E23]">
                  <span className="text-[#000000]">
                    United players and fans through teamwork and sportsmanship
                  </span>
                </li>
                <li className="text-[#C81E23]">
                  <span className="text-[#000000]">
                    Showcased competitive spirit and fair play at its finest
                  </span>
                </li>
                <li className="text-[#C81E23]">
                  <span className="text-[#000000]">
                    Discovered and highlighted emerging football talents
                  </span>
                </li>
              </ul>
              <Link href="/about/vision">
