  ...
  return (
    <div>
      ...
      <div className="lg:flex lg:flex-row flex-col gap-7 justify-center">
        <div className="bg-gradient-to-br from-[#000000] justify-center h-[200px] to-[#C81E23] rounded-md p-4 lg:w-[30%] w-auto">
        ...
        <div className="bg-gradient-to-br from-[#000000] to-[#C81E23] h-[200px] rounded-md p-4 lg:w-[30%] w-auto lg:my-0 my-5">
        ...
        <div className="bg-gradient-to-br from-[#000000] to-[#C81E23] h-[200px] rounded-md p-4 lg:w-[30%] w-auto ">
          <h1 className="text-xl font-bold tracking-tight">
