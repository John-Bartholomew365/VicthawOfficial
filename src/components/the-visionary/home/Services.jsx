...
//   return (
//     <div className="lg:flex lg:flex-row flex-col items-center justify-center min-h-screen p-3 lg:p-10">
//       {/* Services List */}
//       <div className="space-y-2 bg-[#000000] p-6 rounded-xl">
...
//       {/* Services Info */}
//       <div className="lg:ml-10 ml-0 lg:mt-0 mt-7 max-w-md">
...
export default function Services() {
  ...
  return (
    <div className="lg:flex lg:flex-row flex-col items-center justify-center min-h-screen p-3 lg:p-10">
      ...
      <div
        className="lg:ml-10 ml-0 lg:mb-0 mb-7 lg:hidden block max-w-md"
        data-aos="fade-left"
      >
        <h2 className="text-4xl lg:text-start text-center font-bold text-[#FFFFFF]">
          My Awesome <span className="text-[#C81E23]">Services</span>
        ...
        <Link href={"/visionary/contact"}>
          <button className="mt-6 px-6 py-3 bg-[#C81E23] w-full text-white font-semibold rounded-lg">
            Contact me
          </button>
        </Link>
      </div>
