...
const ServicesCta = () => {
  ...
  return (
    <section className="py-16 rounded-md lg:mx-[40px] mx-[10px] mb-24 bg-[#FAFAFA]">
      <div className="container mx-auto px-4 text-center" data-aos="fade-up">
        <h2 className="lg-text-[40px] text-[30px] leading-tight tracking-tight font-bold mb-4 text-black">
          Ready to Train, Transform, and Thrive?
        </h2>
        <p className="text-[16px] tracking-tight text-[#6B6F76] m-auto lg:w-[480px] leading-tight w-auto mb-8">
