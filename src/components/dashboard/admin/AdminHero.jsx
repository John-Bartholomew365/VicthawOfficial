...
//       {/* Team Management */}
//       <div className="bg-[#0F0F0F] lg:p-6 p-3 rounded-lg shadow-lg mb-8">
//         <h2 className="text-lg font-bold text-[#C81E23] mb-4">
//           Team Management
//         </h2>
//         <div className="overflow-x-auto">
...
//                 <th className="text-left py-4 px-4">Coach</th>
//                 <th className="text-left py-4 px-4">Payment Proof</th>
...
//               {teams.map((team) => (
//                 <tr key={team.id} className="border-b border-[#1F1F1F]">
//                   <td className="py-4 px-4 whitespace-nowrap">{team?.team_name}</td>
...
//                     </span>
//                   </td>
//                   <td className="py-4 px-4 whitespace-nowrap">{team.email}</td>
//                   <td className="py-4 px-4 whitespace-nowrap">{team?.manager_name}</td>
//                   <td className="py-4 px-4 whitespace-nowrap">
//                     {team?.payment_proof ? (
//                       <a
//                         href={`${process.env.BASE_URL}/${team?.payment_proof}`}
        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr>
              ...
              <th className="text-left py-4 px-4 whitespace-nowrap">Email</th>
              <th className="text-left py-4 px-4 whitespace-nowrap">Coach</th>
              <th className="text-left py-4 px-4 whitespace-nowrap">
                Payment Proof
              </th>
              <th className="text-left py-4 px-4 whitespace-nowrap">Actions</th>
            </tr>
          </thead>
          <tbody>
            {teams.map((team) => (
