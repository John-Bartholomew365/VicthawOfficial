        ...
        <div className="my-8">
          ...
          <div className="my-3">
            ...
            <input
              ...
              className="w-full p-3 rounded-lg border border-gray-600 focus:outline-none focus:border-[#C81E23] text-black"
            />
          </div>
          <div className="my-3">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className=" px-4 py-2 bg-[#C81E23] text-white rounded-lg hover:bg-[#A3181C] transition"
            >
              Submit
            </button>
          </div>
